...
const Mylists = () => {
  ...
  const breadcrumbItems = [
    ...
    {
      label: PATH.ARCHIVEDLIST.name,
      path: PATH.ARCHIVEDLIST.path,
    },
  ];
    ...
    const fetchMyLists = async () => {
      try {
        const dataa = await fetcher(
          getEndpointUrl(ENDPOINTS.getUnArchivedList(user ? user.id : 0)),
        );
        ...
        <div className="w-full lg:container px-5 pos_r">
          ...
          <div className="flex justify-between">
            <div className="text-left">
              <h1 className="default_text_color header-font">Archived Lists</h1>
            </div>
          </div>
          <div className="pt-6">
            <hr />
          ...
          {showTable ? (
            <div className="card py-6">
              <div className="archived_list_table">
                <DataTable
            ...
            <div className="pt-6 text-center">
              <p className="text-sm font-normal italic">
                You have no archived lists to display
              </p>
            </div>
          )}
